    ...
    def create_market_heatmap(self, stocks_data: Dict[str, Any]):
        ...
        try:
            ...
            for symbol, data in stocks_data.items():
                ...
                names.append(data.get('name', symbol))
...
def main():
    ...
    if st.session_state.comprehensive_data:
        ...
        ### 📊 **다중 데이터 소스**
        - **Yahoo Finance**: 실시간 주식, 지수, 원자재 데이터
        - **FRED API**: 연방준비제도 경제 지표
        - **Reddit API**: 소셜 미디어 감정 분석
        - **Alpha Vantage**: 고급 시장 분석 데이터
